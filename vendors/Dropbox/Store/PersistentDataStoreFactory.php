...
namespace CodeConfig\IDB\Dropbox\Store;
...
class PersistentDataStoreFactory
{
     ...
     *
     * @param null|string|\CodeConfig\IDB\Dropbox\Store\PersistentDataStoreInterface $store
     *
    ...
    public static function makePersistentDataStore($store = null)
    {
        ...
        throw new InvalidArgumentException('The persistent data store must be set to null, "session" or be an instance of use \CodeConfig\IDB\Dropbox\Store\PersistentDataStoreInterface');
    }
}
