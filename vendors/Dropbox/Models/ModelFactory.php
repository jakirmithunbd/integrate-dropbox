...
class ModelFactory
{
     ...
     *
     * @return FileMetadata|FolderMetadata|FileLinkMetadata|FolderLinkMetadata|TemporaryLink|MetadataCollection|SearchResults|AsyncJob|DeletedMetadata|Tag|BaseModel
     */
