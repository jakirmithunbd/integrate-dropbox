...
class MetadataCollection
{
     ...
     * @const string
     */
    public static $COLLECTION_ITEMS_KEY = ['entries', 'links', 'matches'];
     ...
     * @const string
     */
    public static $COLLECTION_CURSOR_KEY = ['cursor', 'start'];
     ...
     * @const string
     */
    public static $COLLECTION_HAS_MORE_ITEMS_KEY = ['has_more', 'more'];
     ...
     *
     * @var \CodeConfig\IDB\Dropbox\Models\ModelCollection
     */
