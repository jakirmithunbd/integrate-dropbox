...
use CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Exception\ConnectException;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Exception\RequestException;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\TransferStats;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Utils;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Promise as P;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Promise\FulfilledPromise;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Promise\PromiseInterface;
use CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\LazyOpenStream;
...
class CurlFactory implements CurlFactoryInterface
{
    ...
    private function applyHandlerOptions(EasyHandle $easy, array &$conf): void
    {
        ...
        if (! isset($options['sink'])) {
            ...
            $options['sink'] = \CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\Utils::tryFopen('php://temp', 'w+');
        }
        $sink = $options['sink'];
        if (! \is_string($sink)) {
