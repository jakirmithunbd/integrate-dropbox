...
namespace CodeConfig\IDB\Dropbox\Illuminate\Support\Traits;

use CachingIterator;
use Closure;
use CodeConfig\IDB\Dropbox\Illuminate\Support\Arr;
use CodeConfig\IDB\Dropbox\Illuminate\Support\Arrayable;
use CodeConfig\IDB\Dropbox\Illuminate\Support\Collection;
use CodeConfig\IDB\Dropbox\Illuminate\Support\Enumerable;
use CodeConfig\IDB\Dropbox\Illuminate\Support\HigherOrderCollectionProxy;
use CodeConfig\IDB\Dropbox\Illuminate\Support\Jsonable;
use Exception;
...
trait EnumeratesValues
{
    ...
    protected function getArrayableItems($items)
    {
        ...
        switch (true) {
            ...
            case $items instanceof UnitEnum: {
                return [$items];
            }
            default:{
                return (array) $items;
