...
class DropboxFile
{
     ...
     * File Stream
     *
     * @var \CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\Stream
     */
    protected $stream;
    ...
    public static function createByStream($fileName, $resource, $mode = self::MODE_READ)
    {
        ...
        $stream = \CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\Utils::streamFor($resource);
        if (! $stream) {
     ...
     *
     * @return \CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\Stream
     * @throws \CodeConfig\IDB\Dropbox\Exceptions\DropboxClientException
     */
    ...
    public function open()
    {
        ...
        // Create a stream
        $this->stream = \CodeConfig\IDB\Dropbox\GuzzleHttp\Psr7\Utils::streamFor(fopen($this->path, $this->mode));
