...
class RandomStringGeneratorFactory
{
     ...
     *
     * @param null|string|\CodeConfig\IDB\Dropbox\Security\RandomStringGeneratorInterface $generator
     *
    ...
    public static function makeRandomStringGenerator($generator = null)
    {
        ...
        //Invalid Argument
        throw new InvalidArgumentException('The random string generator must be set to "mcrypt", "openssl" or be an instance of CodeConfig\IDB\Dropbox\Security\RandomStringGeneratorInterface');
    }
