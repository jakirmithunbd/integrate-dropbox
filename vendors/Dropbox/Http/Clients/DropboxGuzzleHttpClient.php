...
use CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Client;
...
use CodeConfig\IDB\Dropbox\Http\DropboxRawResponse;
...
class DropboxGuzzleHttpClient implements DropboxHttpClientInterface
{
     ...
     * GuzzleHttp client.
     *
     * @var \CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Client
     */
    protected $client;
     ...
     *
     * @param \CodeConfig\IDB\Dropbox\GuzzleHttp\Guzzle\Client|null $client GuzzleHttp Client
     */
     ...
     * Get the Response Body.
     *
     * @param string|\CodeConfig\IDB\Dropbox\Psr\Message\ResponseInterface $response Response object
     *
     * @return string
     */
