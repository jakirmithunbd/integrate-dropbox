...
use CodeConfig\IDB\Dropbox\Http\RequestBodyJsonEncoded;
use CodeConfig\IDB\Dropbox\Http\RequestBodyStream;
...
class DropboxRequest
{
     ...
     * File to upload
     *
     * @var \CodeConfig\IDB\Dropbox\DropboxFile
     */
    protected $file = null;

    /**
     * Raw data to send with the request
     *
     * @var string|null
     */
     ...
     * @param \CodeConfig\IDB\Dropbox\Models\AccessToken $accessToken Access Token for the Request
     ...
     * @param string
     *
     * @return \CodeConfig\IDB\Dropbox\DropboxRequest
     */
     ...
     *
     * @return \CodeConfig\IDB\Dropbox\Http\RequestBodyJsonEncoded
     */
     ...
     *
     * @return \CodeConfig\IDB\Dropbox\Http\RequestBodyStream
     */
     ...
     *
     * @param \CodeConfig\IDB\Dropbox\DropboxFile
     *
     * @return \CodeConfig\IDB\Dropbox\DropboxRequest
     */
    ...
    {
        return ! is_null($this->rawData) ? true : false;
    }
    ...
    protected function processParams(array $params)
    {
        ...
        if (isset($params['raw']) && is_string($params['raw'])) {
            //Raw data to be sent
            $this->setRawData($params['raw']);
            //Remove the raw item from the params array
            unset($params['raw']);
        }
